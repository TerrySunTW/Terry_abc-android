...
import com.abc.terry_sun.abc.Models.ListItem_Bouns;
 ...
 */
public class Adapter_BounsList extends BaseAdapter {
    private Activity activity;
    private List<ListItem_Bouns> stringPairList;


    public Adapter_BounsList(Activity activity, List<ListItem_Bouns> stringPairList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemInfo1.setText(((ListItem_Bouns)stringPairList.get(position)).getTitle1());
        ItemInfo2.setText(((ListItem_Bouns)stringPairList.get(position)).getTitle2());
