...
public class ActionsListActivity extends Activity {
	...
	private void UI_Setting() {
		...
		data.add(new ListItem_Actions("10% off Baseball Game ticket(Y/X)","-Need to go an action X times,Already Y times,need Z times."));
		data.add(new ListItem_Actions("簽名球一顆(95/100)","-100 detections by friends. Now, 95"));
